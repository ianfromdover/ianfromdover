...
export default function Page() {
  ...
  return (
    <section>
      <h1>Hi, I'm Ian!</h1>
      <p>
        I'm a UX designer with a computer science background based in Singapore. I specialise in rigorous user research and designing user-centered solutions that are technically feasible.
      </p>
      <p>
